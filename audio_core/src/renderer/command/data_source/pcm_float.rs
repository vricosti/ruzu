...
#[repr(C)]
pub struct PcmFloatDataSourceVersion1Payload {
...
impl PcmFloatDataSourceVersion1Payload {
    ...
    pub fn verify(&self) -> bool {
        verify_pcm_float_data_source_version1_command(self)
    }

    pub fn dump(&self, target_sample_rate: u32, dump: &mut String) {
        dump_pcm_float_data_source_version1_command(self, target_sample_rate, dump);
    }
}
...
impl PcmFloatDataSourceVersion2Payload {
    ...
    pub fn verify_v2(&self) -> bool {
        verify_pcm_float_data_source_version2_command(self)
    }

    pub fn dump_v2(&self, target_sample_rate: u32, dump: &mut String) {
        dump_pcm_float_data_source_version2_command(self, target_sample_rate, dump);
    }
}

pub fn write_pcm_float_data_source_version1_payload(
    command: &DataSourceCommand,
    output: &mut [u8],
) -> usize {
    write_pcm_float_data_source_payload(command, output)
}

pub fn write_pcm_float_data_source_version2_payload(
    command: &DataSourceCommand,
    output: &mut [u8],
) -> usize {
    write_pcm_float_data_source_payload(command, output)
...
pub fn verify_pcm_float_data_source_version1_command(
    _payload: &PcmFloatDataSourceVersion1Payload,
) -> bool {
    true
}

pub fn verify_pcm_float_data_source_version2_command(
    _payload: &PcmFloatDataSourceVersion2Payload,
) -> bool {
    true
}

pub fn dump_pcm_float_data_source_version1_command(
    payload: &PcmFloatDataSourceVersion1Payload,
    target_sample_rate: u32,
    dump: &mut String,
) {
...
pub fn dump_pcm_float_data_source_version2_command(
    payload: &PcmFloatDataSourceVersion2Payload,
    target_sample_rate: u32,
    dump: &mut String,
) {
...
fn write_pcm_float_data_source_payload(command: &DataSourceCommand, output: &mut [u8]) -> usize {
    let mut payload: PcmFloatDataSourceVersion1Payload = unsafe { std::mem::zeroed() };
