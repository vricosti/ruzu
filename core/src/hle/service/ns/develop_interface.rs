...
impl IDevelopInterface {
    pub fn new() -> Self {
        let handlers = build_handler_map(&[
            ...
            (commands::TERMINATE_APPLICATION, None, "TerminateApplication"),
            (commands::PREPARE_LAUNCH_PROGRAM_FROM_HOST, None, "PrepareLaunchProgramFromHost"),
            (commands::LAUNCH_APPLICATION_FROM_HOST, None, "LaunchApplicationFromHost"),
            (commands::LAUNCH_APPLICATION_WITH_STORAGE_ID_FOR_DEVELOP, None, "LaunchApplicationWithStorageIdForDevelop"),
            (commands::IS_SYSTEM_MEMORY_RESOURCE_LIMIT_BOOSTED, None, "IsSystemMemoryResourceLimitBoosted"),
            (commands::GET_RUNNING_APPLICATION_PROCESS_ID_FOR_DEVELOP, None, "GetRunningApplicationProcessIdForDevelop"),
            (commands::SET_CURRENT_APPLICATION_RIGHTS_ENVIRONMENT_CAN_BE_ACTIVE_FOR_DEVELOP, None, "SetCurrentApplicationRightsEnvironmentCanBeActiveForDevelop"),
            (commands::CREATE_APPLICATION_RESOURCE_FOR_DEVELOP, None, "CreateApplicationResourceForDevelop"),
            (commands::IS_PREOMIA_FOR_DEVELOP, None, "IsPreomiaForDevelop"),
            (commands::GET_APPLICATION_PROGRAM_ID_FROM_HOST, None, "GetApplicationProgramIdFromHost"),
            (commands::REFRESH_CACHED_DEBUG_VALUES, None, "RefreshCachedDebugValues"),
            (commands::PREPARE_LAUNCH_APPLICATION_FROM_HOST, None, "PrepareLaunchApplicationFromHost"),
