...
impl IFactorySettingsServer {
    pub fn new() -> Self {
        let handlers = build_handler_map(&[
            (commands::GET_BLUETOOTH_BD_ADDRESS, None, "GetBluetoothBdAddress"),
            (commands::GET_CONFIGURATION_ID1, None, "GetConfigurationId1"),
            (commands::GET_ACCELEROMETER_OFFSET, None, "GetAccelerometerOffset"),
            (commands::GET_ACCELEROMETER_SCALE, None, "GetAccelerometerScale"),
            (commands::GET_GYROSCOPE_OFFSET, None, "GetGyroscopeOffset"),
            (commands::GET_GYROSCOPE_SCALE, None, "GetGyroscopeScale"),
            (commands::GET_WIRELESS_LAN_MAC_ADDRESS, None, "GetWirelessLanMacAddress"),
            (commands::GET_WIRELESS_LAN_COUNTRY_CODE_COUNT, None, "GetWirelessLanCountryCodeCount"),
            (commands::GET_WIRELESS_LAN_COUNTRY_CODES, None, "GetWirelessLanCountryCodes"),
            (commands::GET_SERIAL_NUMBER, None, "GetSerialNumber"),
            (commands::SET_INITIAL_SYSTEM_APPLET_PROGRAM_ID, None, "SetInitialSystemAppletProgramId"),
            (commands::SET_OVERLAY_DISP_PROGRAM_ID, None, "SetOverlayDispProgramId"),
            (commands::GET_BATTERY_LOT, None, "GetBatteryLot"),
            (commands::GET_ECI_DEVICE_CERTIFICATE, None, "GetEciDeviceCertificate"),
            (commands::GET_ETICKET_DEVICE_CERTIFICATE, None, "GetEticketDeviceCertificate"),
            ...
            (commands::GET_GAME_CARD_CERTIFICATE, None, "GetGameCardCertificate"),
            (commands::GET_ECI_DEVICE_KEY, None, "GetEciDeviceKey"),
            (commands::GET_ETICKET_DEVICE_KEY, None, "GetEticketDeviceKey"),
            (commands::GET_SPEAKER_PARAMETER, None, "GetSpeakerParameter"),
            (commands::GET_LCD_VENDOR_ID, None, "GetLcdVendorId"),
            (commands::GET_ECI_DEVICE_CERTIFICATE2, None, "GetEciDeviceCertificate2"),
            (commands::GET_ECI_DEVICE_KEY2, None, "GetEciDeviceKey2"),
            (commands::GET_AMIIBO_KEY, None, "GetAmiiboKey"),
            (commands::GET_AMIIBO_ECQV_CERTIFICATE, None, "GetAmiiboEcqvCertificate"),
            (commands::GET_AMIIBO_ECDSA_CERTIFICATE, None, "GetAmiiboEcdsaCertificate"),
            (commands::GET_AMIIBO_ECQV_BLS_KEY, None, "GetAmiiboEcqvBlsKey"),
            (commands::GET_AMIIBO_ECQV_BLS_CERTIFICATE, None, "GetAmiiboEcqvBlsCertificate"),
            (commands::GET_AMIIBO_ECQV_BLS_ROOT_CERTIFICATE, None, "GetAmiiboEcqvBlsRootCertificate"),
            (commands::GET_USB_TYPE_C_POWER_SOURCE_CIRCUIT_VERSION, None, "GetUsbTypeCPowerSourceCircuitVersion"),
            (commands::GET_ANALOG_STICK_MODULE_TYPE_L, None, "GetAnalogStickModuleTypeL"),
            (commands::GET_ANALOG_STICK_MODEL_PARAMETER_L, None, "GetAnalogStickModelParameterL"),
            (commands::GET_ANALOG_STICK_FACTORY_CALIBRATION_L, None, "GetAnalogStickFactoryCalibrationL"),
            (commands::GET_ANALOG_STICK_MODULE_TYPE_R, None, "GetAnalogStickModuleTypeR"),
            (commands::GET_ANALOG_STICK_MODEL_PARAMETER_R, None, "GetAnalogStickModelParameterR"),
            (commands::GET_ANALOG_STICK_FACTORY_CALIBRATION_R, None, "GetAnalogStickFactoryCalibrationR"),
            (commands::GET_CONSOLE_SIX_AXIS_SENSOR_MODULE_TYPE, None, "GetConsoleSixAxisSensorModuleType"),
            (commands::GET_CONSOLE_SIX_AXIS_SENSOR_HORIZONTAL_OFFSET, None, "GetConsoleSixAxisSensorHorizontalOffset"),
            (commands::GET_BATTERY_VERSION, None, "GetBatteryVersion"),
            (commands::GET_DEVICE_ID, None, "GetDeviceId"),
            (commands::GET_CONSOLE_SIX_AXIS_SENSOR_MOUNT_TYPE, None, "GetConsoleSixAxisSensorMountType"),
        ]);
        Self {
            handlers,
