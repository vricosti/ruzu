...
pub fn emit_select_u1(ctx: &mut SpirvEmitContext, cond: Word, true_val: Word, false_val: Word) -> Word {
    ctx.builder
...
pub fn emit_select_u32(ctx: &mut SpirvEmitContext, cond: Word, true_val: Word, false_val: Word) -> Word {
    ctx.builder
...
pub fn emit_select_u64(ctx: &mut SpirvEmitContext, cond: Word, true_val: Word, false_val: Word) -> Word {
    ctx.builder
...
pub fn emit_select_f32(ctx: &mut SpirvEmitContext, cond: Word, true_val: Word, false_val: Word) -> Word {
    ctx.builder
...
pub fn emit_select_f64(ctx: &mut SpirvEmitContext, cond: Word, true_val: Word, false_val: Word) -> Word {
    ctx.builder
