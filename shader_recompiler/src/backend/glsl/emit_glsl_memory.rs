...
pub fn emit_write_storage_u8(ctx: &mut EmitContext, binding: &str, offset: &str) {
    ctx.add_fmt(format!(
        "ssbo{}[{}/4]=bitfieldInsert(ssbo{}[{}/4],u_0,int(({})%4)*8,8);",
