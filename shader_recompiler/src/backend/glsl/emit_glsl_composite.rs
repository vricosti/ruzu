...
pub fn emit_composite_construct_u32x4(ctx: &mut EmitContext, e1: &str, e2: &str, e3: &str, e4: &str) {
...
pub fn emit_composite_construct_f32x4(ctx: &mut EmitContext, e1: &str, e2: &str, e3: &str, e4: &str) {
...
pub fn emit_composite_insert_f32x2(ctx: &mut EmitContext, composite: &str, object: &str, index: u32) {
    let swz = ["x", "y"][index as usize];
    ctx.add_fmt(format!("f2_0={};f2_0.{}={};", composite, swz, object));
}
pub fn emit_composite_insert_f32x3(ctx: &mut EmitContext, composite: &str, object: &str, index: u32) {
    let swz = ["x", "y", "z"][index as usize];
    ctx.add_fmt(format!("f3_0={};f3_0.{}={};", composite, swz, object));
}
pub fn emit_composite_insert_f32x4(ctx: &mut EmitContext, composite: &str, object: &str, index: u32) {
    let swz = ["x", "y", "z", "w"][index as usize];
