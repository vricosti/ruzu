...
fn integer_compare(tv: &mut TranslatorVisitor, a: Value, b: Value, op: u32, signed: bool) -> Value {
    match op {
        ...
        1  => if signed { tv.ir.s_less_than(a, b)         } else { tv.ir.u_less_than(a, b)         }, // LT
        2  => tv.ir.i_equal(a, b),      // EQ
        3  => if signed { tv.ir.s_less_than_equal(a, b)   } else { tv.ir.u_less_than_equal(a, b)   }, // LE
        // 4–15 unused; 16 onward for GT/NE/GE/True
        16 => if signed { tv.ir.s_greater_than(a, b)      } else { tv.ir.u_greater_than(a, b)      }, // GT
        17 => tv.ir.i_not_equal(a, b),  // NE
        18 => if signed { tv.ir.s_greater_than_equal(a, b)} else { tv.ir.u_greater_than_equal(a, b)}, // GE
